...
#define USB_STANDARD_GET_INTERFACE  0x0A /**<\brief Returns the selected alternate setting for the specified \
                                            interface.*/
#define USB_STANDARD_SET_INTERFACE \
    0x0B /**<\brief Allows the host to select an alternate setting for the specified interface.*/
...
typedef struct
{
    ...
    uint16_t wTotalLength;   /**<\brief Size of the configuration descriptor header, and all sub descriptors attached to
                                the configuration.*/
